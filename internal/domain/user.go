...
type User struct {
	...
	NoTelp       string    `gorm:"column:no_telp;type:varchar(255);unique;not null" json:"no_telp"`
	TanggalLahir string    `gorm:"column:tanggal_lahir;type:date" json:"tanggal_lahir"`
